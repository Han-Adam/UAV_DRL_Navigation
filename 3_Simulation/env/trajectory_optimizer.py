...
class MinimumAcc:
    ...
    def solve(self):
        ...
        A x = b
        """
        self.p_x = solve_qp(self.Q, self.q, self.G, self.h, self.A, self.b_x, solver='scs')
        self.p_y = solve_qp(self.Q, self.q, self.G, self.h, self.A, self.b_y, solver='scs')
        self.p_z = solve_qp(self.Q, self.q, self.G, self.h, self.A, self.b_z, solver='scs')
